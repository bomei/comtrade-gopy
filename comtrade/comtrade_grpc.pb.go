...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/comtrade.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) FastLoad(ctx context.Context, in *DatParseParam, opts ...grpc.CallOption) (*WaveDataReply, error) {
	...
	err := c.cc.Invoke(ctx, "/comtrade.Greeter/FastLoad", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) TestFastLoad(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*Analog, error) {
	out := new(Analog)
	err := c.cc.Invoke(ctx, "/comtrade.Greeter/TestFastLoad", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comtrade.Greeter/SayHello",
	}
...
func _Greeter_FastLoad_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(GreeterServer).FastLoad(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comtrade.Greeter/FastLoad",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Greeter_TestFastLoad_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comtrade.Greeter/TestFastLoad",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "comtrade/comtrade.proto",
}
